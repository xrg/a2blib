<?php
//require_once('adodb.inc.php'); // AdoDB
...
abstract class AbstractSession {
	...
	public function &DBHandle_p(){
		...
		$this->set_def_conf('database','user','dbuser','USER');	// changed from 'postgres'
		$this->set_def_conf('database','password',null,'PASS');
		$this->set_def_conf('database','dbname','dbname','DBNAME');
